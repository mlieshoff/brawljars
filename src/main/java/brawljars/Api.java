...
public class Api {
  ...
  public GetBrawlerResponse getBrawler(GetBrawlerRequest getBrawlerRequest) {
    return executeRequest(getBrawlerRequest, client -> client.getBrawler(getBrawlerRequest));
  }
