...
class RankingApiImpl extends BaseApi implements RankingApi {
  ...
  public Future<PowerplayRankingsResponse> findPowerplayRankings(PowerplayRankingsRequest powerplayRankingsRequest) {
    return get("/rankings/{countryCode}/powerplay/seasons/{seasonId}", powerplayRankingsRequest,
  ...
  public Future<PowerplayRankingsSeasonsResponse> findPowerplayRankingsSeasons(
    ...
    return get("/rankings/{countryCode}/powerplay/seasons", powerplayRankingsSeasonsRequest,
