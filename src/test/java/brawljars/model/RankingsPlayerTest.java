...
class RankingsPlayerTest {

  private RankingsPlayer unitUnderTest;

  @BeforeEach
  void setUp() {
    unitUnderTest = new RankingsPlayer();
  }

  @Test
  void setClub_whenWithValidParameter_thenSetClub() {
    RankingsPlayerClub expected = new RankingsPlayerClub();
  ...
  void setIcon_whenWithValidParameter_thenSetIcon() {
    RankingsPlayerIcon expected = new RankingsPlayerIcon();
  ...
  void toString_whenCalled_thenReturnStringRepresentation() {
    unitUnderTest.setClub(new RankingsPlayerClub());
    unitUnderTest.setIcon(new RankingsPlayerIcon());
    ...
    String
        expected =
        "RankingsPlayer(club=" + new RankingsPlayerClub() + ", icon=" + new RankingsPlayerIcon()
