...
public class PlayerApiImplIntegrationTest extends IntegrationTestBase {
  ...
  brawljars.api.intern.players.player.PlayerRequest request = brawljars.api.intern.players.player.PlayerRequest.builder(playerTag)
    ...
    brawljars.api.intern.players.player.PlayerResponse actual = unitUnderTest.findById(request).get();
  ...
  brawljars.api.intern.players.battlelog.BattleLogRequest request = brawljars.api.intern.players.battlelog.BattleLogRequest.builder(playerTag)
    ...
    brawljars.api.intern.players.battlelog.BattleLogResponse actual = unitUnderTest.findBattleLog(request).get();
