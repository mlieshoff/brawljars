...
public class PlayerApiImplIntegrationTest extends IntegrationTestBase {
  ...
  void findById() throws Exception {
    ...
    brawljars.api.intern.players.player.PlayerRequest playerRequest = brawljars.api.intern.players.player.PlayerRequest.builder(playerTag).build();
    prepare("/players/{playerTag}".replace("{playerTag}", playerTag), "src/test/resources/player-findById.json");
  ...
  void findBattleLog() throws Exception {
    String playerTag = "playerTag";
    brawljars.api.intern.players.battlelog.BattleLogRequest battleLogRequest = brawljars.api.intern.players.battlelog.BattleLogRequest.builder(playerTag).build();
    prepare("/players/{playerTag}/battlelog".replace("{playerTag}", playerTag), "src/test/resources/player-findBattleLog.json");
